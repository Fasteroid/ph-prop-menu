...
PCR.CVAR.DefaultKey		= CreateConVar("pcr_default_key_menu", KEY_F4, svonly, "Key that should be used to bring up the Prop Chooser Menu. Default is KEY_F4.\nSee on this Wiki for buttons: https://wiki.garrysmod.com/page/Enums/BUTTON_CODE")
...
local ADDON_INFO = {
	...
	info	= "Prop Chooser Addon. Press [F4] by default to open Prop Chooser.",
